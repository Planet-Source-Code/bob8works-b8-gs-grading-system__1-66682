VERSION 5.00
Begin VB.UserControl b8ClientWin 
   Alignable       =   -1  'True
   BackColor       =   &H00FFFFFF&
   ClientHeight    =   390
   ClientLeft      =   0
   ...
   Begin b8Controls4.b8WinTabs b8WT 
      ...
      _extentx        =   53
      _extenty        =   661
      font            =   "b8ClientWin.ctx":0000
      font            =   "b8ClientWin.ctx":0028
   End
   Begin VB.Image imgBR 
      Height          =   1605
      Left            =   0
      MousePointer    =   9  'Size W E
      Picture         =   "b8ClientWin.ctx":0050
      Stretch         =   -1  'True
      Top             =   0
      Width           =   90
   End
   Begin VB.Image Image1 
      Height          =   360
      Left            =   0
      Picture         =   "b8ClientWin.ctx":009E
      Stretch         =   -1  'True
      Top             =   0
      Width           =   19995
   End
End
Attribute VB_Name = "b8ClientWin"
...
Public Sub LoadChildWindow(ByRef ParentHwnd As Long, _
    ...
    'add window to tab
    b8WT.AddForm sFormName, sFormCaption, ShowCloseButton
...
Private Sub b8WT_CloseClick(sFormName As String, Index As Integer)
...
Private Sub UserControl_Resize()
    ...
    b8WT.Move (m_SBWidth + 2), 0, GetWidth - (m_SBWidth + 2)
    Err.Clear
End Sub
