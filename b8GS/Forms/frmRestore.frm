...
Private Sub cmdStart_Click()
    ...
    If MsgBox("Do you want to overwrite the current Database file wth this newly restored file?", vbQuestion + vbOKCancel) = vbOK Then
        ...
        'close databse
        modMain.PrimeData.Close
        
        
        'delete current db file
        If FSO.FileExists(modMain.DBPathFileName) = True Then
            FSO.DeleteFile modMain.DBPathFileName
        End If
        
        'move database file
        FSO.MoveFile stmpFP, modMain.DBPathFileName
        
        'reconnect database file
        If modMain.OpenDB = True Then
