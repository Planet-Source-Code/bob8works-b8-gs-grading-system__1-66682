      ...
      Begin MSComctlLib.ImageList ilList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAllStudent.frx":000C
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Private Sub Form_Load()
    ...
    With listEntries
        ...
        .AddColumn "Student ID", 100         '0
        .AddColumn "Last Name", 120   '1
        .AddColumn "First Name", 100   '2
        .AddColumn "Middle Name", 100   '3
        .AddColumn "Y.L.", 50   '4
        .AddColumn "Created", 120   '5
        .AddColumn "Modified Date", 120   '6
        .AddColumn "Active", 60   '7
...
Private Sub LoadEntries()
    ...
    'set SQL Expression
    sSQL = "SELECT tblStudent.StudentID, tblStudent.LastName, tblStudent.FirstName, tblStudent.MiddleName, tblStudent.YL, tblStudent.CreationDate, tblStudent.ModifiedDate, tblStudent.Active" & _
            " From tblStudent" & _
    ...
    While vRS.EOF = False
        ...
        With listEntries
            il = .AddItem(modFunction.ComNumZ(ReadField(vRS.Fields("StudentID")), 10))
            .ItemImage(il) = 1
            .CellFontBold(il, 1) = True
            .CellFontBold(il, 2) = True
            .CellFontBold(il, 3) = True
            .CellText(il, 1) = ReadField(vRS.Fields("LastName"))
            .CellText(il, 2) = ReadField(vRS.Fields("FirstName"))
            .CellText(il, 3) = ReadField(vRS.Fields("MiddleName"))
            .CellText(il, 4) = modYL.YLNumToStr(CInt(ReadField(vRS.Fields("YL"))))
            .CellText(il, 5) = ReadField(vRS.Fields("CreationDate"))
            .CellText(il, 6) = ReadField(vRS.Fields("ModifiedDate"))
            .CellText(il, 7) = IIf(ReadField(vRS.Fields("Active")), "YES", "NO")
...
Public Function Form_Add()
    ...
    If frmStudentEntry.ShowAdd = True Then
        Form_Refresh
    End If
...
Public Function Form_Edit()
    ...
    lStudentID = GetTxtVal(listEntries.CellText(listEntries.Row, 0))
    
    If frmStudentEntry.ShowEdit(lStudentID) = True Then
        Form_Refresh
    End If
...
Public Function Form_Delete()
    ...
    If DeleteStudent(lStudentID) = True Then
        Form_Refresh
    Else
...
Public Function Form_SetSearch(ByRef sFields() As String)
    If listEntries.RowCount > 0 Then
        ...
        sFields(0) = "Student ID" ' 100         '0
        sFields(1) = "Last Name" ' 120   '1
        sFields(2) = "First Name" ' 100   '2
        sFields(3) = "Middle Name" ' 100   '3
        sFields(4) = "Y.L." ' 50   '4
        sFields(5) = "Created" ' 120   '5
        sFields(6) = "Modified Date" ' 120   '6
        sFields(7) = "Active" ' 60   '7
...
Private Sub mnuViewRecords_Click()
    If listEntries.RowCount > 0 Then
        frmStudentRecord.ShowForm CLng(listEntries.CellText(listEntries.Row, 0))
    End If
End Sub
