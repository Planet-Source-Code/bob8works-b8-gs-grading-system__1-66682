...
Public Sub ShowForm(ByVal sModuleName As String, ByVal sRoutineName As String, ByVal sDetail As String)
    ...
    lblMsg.Caption = "Grading System Beta has encountered a problem." & vbNewLine & "We are sorry for the inconvenience." & vbNewLine & vbNewLine & "Module: '" & sModuleName & "'" & vbNewLine & _
