VERSION 5.00
Object = "*\A..\..\..\..\GRADIN~1\Code\b8Controls4\b8Controls4.vbp"
Object = "{831FDD16-0C5C-11D2-A9FC-0000F8754DA1}#2.0#0"; "MSCOMCTL.OCX"
Begin VB.Form frmAllCourse 
   BackColor       =   &H00F5F5F5&
   BorderStyle     =   0  'None
   Caption         =   "Courses"
   ClientHeight    =   5685
   ...
   End
End
Attribute VB_Name = "frmAllCourse"
...
Private Sub Form_Load()
    ...
    With listEntries
        ...
        .AddColumn "ID", 100         '0
        .AddColumn "Title", 200         '1
        .AddColumn "Description", 300         '2
...
Private Sub LoadEntries()
    ...
    'set SQL Expression
    sSQL = "SELECT tblCourse.CourseID, tblCourse.Title, tblCourse.Description" & _
            " From tblCourse" & _
    ...
    While vRS.EOF = False
        ...
        With listEntries
            il = .AddItem(ReadField(vRS.Fields("CourseID")))
            .ItemImage(il) = 1
            .CellText(il, 1) = ReadField(vRS.Fields("Title"))
            .CellText(il, 2) = ReadField(vRS.Fields("Description"))
        End With
...
Public Function Form_Add()
    ...
    If frmCourseEntry.ShowAdd = True Then
        Form_Refresh
    End If
...
Public Function Form_Edit()
    ...
    Dim lCourseID As Integer
    
    If listEntries.RowCount < 1 Then
        Exit Function
    End If
    
    lCourseID = GetTxtVal(listEntries.CellText(listEntries.Row, 0))
    
    If frmCourseEntry.ShowEdit(lCourseID) = True Then
        Form_Refresh
    End If
...
Public Function Form_Delete()
    ...
    If MsgBox("Are you sure you want to delete this Course entry named   '" & listEntries.CellText(listEntries.Row, 1) & "' ?", vbQuestion + vbYesNo + vbDefaultButton2) <> vbYes Then
        Exit Function
    End If
    ...
    If DeleteCourse(lCourseID) = True Then
        Form_Refresh
    Else
        WriteErrorLog Me.Name, "Form_Delete", "Failed on: 'DeleteCourse(lCourseID) = True'"
    End If
