VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} drRank 
   Caption         =   "Ranking List"
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Pioneer Ave., General Santos City"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "drRank"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Public Sub ShowReport(ByRef vRS As ADODB.Recordset)
    
    Set Me.DataSource = vRS
...
End Sub
'"SELECT TOP " & iMaxCount & " tblEnrollment.EnrollmentID, (String(10-Len(Trim(tblEnrollment.FK_StudentID)),'0')&tblEnrollment.FK_StudentID) as StudIDFull, (tblStudent.MiddleName & ', ' & tblStudent.FirstName & ' ' & tblStudent.LastName) AS StudentFullName, tblCourse.Title, tblEnrollment.YL, Avg(tblStudentSubject.Grade) AS AvgOfGrade" & _
